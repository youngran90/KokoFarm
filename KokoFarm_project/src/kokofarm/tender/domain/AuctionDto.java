...
public class AuctionDto {
	...
	public String toString() {
		return "AuctionDto [auction_no=" + auction_no + ", seller_no=" + seller_no + ", auction_name=" + auction_name
				...
				+ auction_file + ", auction_result=" + auction_result + ", auction_detailImg=" + auction_detailImg
				+ ", auction_detailImg2=" + auction_detailImg2 + "]";
	}
